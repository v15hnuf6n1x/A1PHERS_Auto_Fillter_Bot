...
PICS = (environ.get('PICS', 'https://graph.org/file/03a2199fc52d292cc2422.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001794747387')
